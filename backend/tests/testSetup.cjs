const APPLICATION_ENV_PREFIXES = ["NEWS_", "NEWSAPI_", "GNEWS_", "MEDIA_", "MEDIASTACK_", "GDELT_", "MARKET_", "TWELVE_", "TWELVEDATA_", "YOUTUBE_", "WATCHLIST_", "REFRESH_", "MANUAL_", "WS_", "IMPACT_", "ADMIN_", "AI_", "NVIDIA_", "AWARENESS_"];
