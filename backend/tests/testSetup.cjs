const APPLICATION_ENV_PREFIXES = ["NEWS_", "NEWSAPI_", "GNEWS_", "MEDIA_", "MEDIASTACK_", "GDELT_", "MARKET_", "TWELVE_", "TWELVEDATA_", "YOUTUBE_", "WATCHLIST_", "REFRESH_", "MANUAL_", "WS_", "IMPACT_", "ADMIN_", "AI_", "NVIDIA_", "LLAMACPP_", "AWARENESS_"];
const APPLICATION_ENV_KEYS = new Set(["PORT", "HOST", "LOG_LEVEL", "ALLOW_LOCAL_ADMIN", "DISABLE_BACKGROUND_REFRESH"]);
